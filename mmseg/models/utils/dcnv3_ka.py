...
# import ops_dcnv3_sw.modules as dcnv3_sw
...
class DCNv3KA(BaseModule):
    def __init__(self,
        ...
        self.dw_dcn = self.core_op(
            ...
            dilation=1,
            group=group,#husk på att vi sender inn group
...
class DCNv3_CA(BaseModule):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.core_op = getattr(dcnv3, core_op)
        self.core_op_2 = getattr(dcnv3_sw, core_op)
        ...
        self.conv1 = self.core_op(
            channels=channels,
            kernel_size=tuple((3,3)),
            stride=1,
            pad=tuple((1,1)),
            dilation=1,
            group=channels,#TODO husk på att vi sender inn group
            offset_scale=offset_scale,
            act_layer=act_layer,
            norm_layer=norm_layer,
            dw_kernel_size=dw_kernel_size, # for InternImage-H/G
        ...
        self.conv3 = nn.Conv2d(channels, channels, 1)
        self.conv_1_2 = nn.Conv2d(channels, channels, 1, groups=channels)
    ...
    def forward(self, x):
        ...
        attn_2 = attn_2.permute(0,2,3,1).contiguous()
